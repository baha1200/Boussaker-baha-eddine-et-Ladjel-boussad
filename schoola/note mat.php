...
<body>
    ...
    <div class="nev">
        <ul>
            <li><a href="note mat.php?lang=ar"><input type="button" value="AR" size="45" /></a>&nbsp;&nbsp;<a href="note mat.php?lang=fr"><input type="button" value="FR" size="45"/></a></li>
  ...
  <input type="submit" style="background: #FFED00;border-radius: 20px;" value="<?php echo $lang['rec']; ?>" onclick="ouvrirpage()">
	...
	<table border="2" bordercolor="#6a9497" cellpadding="0" style="background:#012531; border-radius: 20px; "  >
		            <tr>
