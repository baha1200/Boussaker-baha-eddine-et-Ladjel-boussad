	   ...
	   function myFunction()
		{
			...
			if(un=="admin" && pw=="admin0000")
				{
					window.location.href="administration0.php";
				}
			else
				{
					alert("invalid !");
...
<body >
    ...
    <div class="nev">
        <ul>
            <li><a href="administration login.php?lang=ar"><input type="button" value="AR" size="45" /></a>&nbsp;&nbsp;<a href="administration login.php?lang=fr"><input type="button" value="FR" size="45"/></a></li>
