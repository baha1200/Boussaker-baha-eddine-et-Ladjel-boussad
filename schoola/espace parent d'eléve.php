...
<head>
    ...
    <title>espace parent eléve</title>
	<style>
		.ad1 a{
...
<body>
    ...
    <div class="nev">
        <ul>
            <li><a href="espace parent d'eléve.php?lang=ar"><input type="button" value="AR" size="45" /></a>&nbsp;&nbsp;<a href="espace parent d'eléve.php?lang=fr"><input type="button" value="FR" size="45"/></a></li>
  ...
  <input type="submit" style="background: #FFED00;border-radius: 20px;" value="<?php echo $lang['rec']; ?>" onclick="ouvrirpage()">
      ...
      <div class="c" style="margin-right: 0cm;">
            ...
            <div class="bolck_head"><?php echo $lang['ep']; ?></div>
            <div class="bolck_body"></div>
           <div class="ad1" style="text-align: center;">
			   <br><br>
                 <pre>
                
                </pre>
			    <a href="l'absence des enseignants parent.php" style="color: #FFF;"><?php echo $lang['absds']; ?></a>
                                      
              
               
                <a href="les notes des eleves part2.php" style="color: #FFF;padding-left: 2cm;"><?php echo $lang['notel']; ?></a><br><br><br><br><br>
			   <video height="500cm" width="1000cm" autoplay muted loop> <source src="photos/vedo3.mp4" type="video/mp4"> </video> 
         </div>
		  <pre>
         </div>
        <div class="l_center">
