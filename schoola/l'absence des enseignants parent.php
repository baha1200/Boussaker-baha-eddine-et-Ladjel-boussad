...
<head>
    ...
    <title>ansence des enseignants parent</title>
...
<body>
    ...
    <div class="nev">
        <ul>
            <li><a href="l'absence des enseignants parent.php?lang=ar"><input type="button" value="AR" size="45" /></a>&nbsp;&nbsp;<a href="l'absence des enseignants parent.php?lang=fr"><input type="button" value="FR" size="45"/></a></li>
  ...
  <input type="submit" style="background: #FFED00;border-radius: 20px;" value="<?php echo $lang['rec']; ?>" onclick="ouvrirpage()">
      ...
      <div class="c" style="margin-right: 0cm;">
            ...
            <div class="bolck_head"><?php echo $lang['absds']; ?></div> <br>
            <div class="bolck_body"></div>
           <div class="ad1">
			   
			   <table border="1" cellpadding="0" bordercolor="#6a9497" style="background:#012531; color:#FFF; border-radius:20px; ">
		      <tr>
			       <th><?php echo $lang['nom']; ?></th>
				   <th><?php echo $lang['clss']; ?></th>
