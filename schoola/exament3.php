...
<body>
    ...
    <div class="nev">
        <ul>
            <li><a href="exament3.php?lang=ar"><input type="button" value="AR" size="45" /></a>&nbsp;&nbsp;<a href="exament3.php?lang=fr"><input type="button" value="FR" size="45"/></a></li>
  ...
  <input type="submit" style="background: #FFED00;border-radius: 20px;" value="<?php echo $lang['rec']; ?>" onclick="ouvrirpage()">
    ...
    <div class="center">
        ...
        <div class="c_center">
            <div class="suled">
                <img src="photos/rouzimti.jpg" width="100%" height="600cm">
            </div>
