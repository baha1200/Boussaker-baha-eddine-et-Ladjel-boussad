...
<head>
    ...
    <title>le hero belaid belkacem</title>
</head>
<body>
    <div class="top_head">
    ...
    <div class="nev">
        <ul>
            <li><a href="le hero BELAID BELKACEM.php?lang=ar"><input type="button" value="AR" size="45" /></a>&nbsp;&nbsp;<a href="le hero BELAID BELKACEM.php?lang=fr"><input type="button" value="FR" size="45"/></a></li>
  ...
  <input type="submit" style="background: #FFED00;border-radius: 20px;" value="<?php echo $lang['rec']; ?>" onclick="ouvrirpage()">
    ...
    <div class="center">
        ...
        <div class="c_center">
            <div class="suled">
                <img src="photos/belaid belkacem 2.png" width="100%" height="300px">
            </div>
            <div class="bolck_head"><?php echo $lang['acta']; ?></div>
            <div class="bolck_body"></div>
            <strong> <p style="font-size: 22px; margin-left:1cm;">
               <?php echo $lang['hrblbl1']; ?>

           
                 <pre><?php echo $lang['hrblbl2']; ?></pre>
                </p></strong>
        </div>
    </div>
    <div class="l_center">
