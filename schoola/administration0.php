...
<head>
    ...
    <title>administration0</title>
		
<script>
	function preventBack() { window.history.forward(); window.history.forward(1); }
	setTimeout("preventBack()", 0);
	window.onunload = function () { null };
    javascript:window.history.forward(1);
</script>
<body>
<div style="height: 1cm;"><a href="administration login.php"> <img src="photos/retr.png" style="height: 3cm; width: 3cm;"></a> </div>
    <div class="top_head">
    ...
    <div class="nev">
        <ul>
            ...
            <li><a href="administration0.php?lang=ar"><input type="button" value="AR" size="45" /></a>&nbsp;&nbsp;<a href="administration0.php?lang=fr"><input type="button" value="FR" size="45"/></a></li>
  ...
  <input type="submit" style="background: #FFED00;border-radius: 20px;" value="<?php echo $lang['rec']; ?>" onclick="ouvrirpage()">
      ...
      <div class="news">
		  ...
		  <marquee><?php echo $lang['pre']; ?></marquee></div>

      <div class="c" style="margin-right: 0cm;">
      
            <div class="bolck_head"><?php echo $lang['ea']; ?></div>
            <div class="bolck_body"></div>
            <p>
               <div class="ad1">
                
<a href="absence des enseignants admin.php" style="color: #FFF;float: right;width: 7cm; text-align: center;"><?php echo $lang['absds']; ?></a>
                                      
              
<a href="les notes des eléves adm .php" style="color: #FFF;float: right;width: 4cm;text-align: center;"><?php echo $lang['notel']; ?></a>

                                   
<a href="les notifications admin.php" style="color: #FFF;float: right;width: 4cm;text-align: center;"><?php echo $lang['ntfi']; ?></a>
                 
      <video height="500cm" width="1000cm" autoplay muted loop> <source src="photos/vedo.mp4" type="video/mp4"> </video>   
				          </div>
