...
<body>
    ...
    <div class="nev">
        <ul>
            <li><a href="note quatr.php?lang=ar"><input type="button" value="AR" size="45" /></a>&nbsp;&nbsp;<a href="note quatr.php?lang=fr"><input type="button" value="FR" size="45"/></a></li>
