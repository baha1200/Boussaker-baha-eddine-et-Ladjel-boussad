...
<body>
    ...
    <div class="nev">
        <ul>
            <li><a href="troisieme.php?lang=ar"><input type="button" value="AR" size="45" /></a>&nbsp;&nbsp;<a href="troisieme.php?lang=fr"><input type="button" value="FR" size="45"/></a></li>
...
function ouvrirpage(){
    ...
    <div class="bolck_head"><?php echo $lang['LL']; ?></div>
