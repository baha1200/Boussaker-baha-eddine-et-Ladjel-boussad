...
<body>
    ...
    <div class="nev">
        <ul>
            <li><a href="premiere.php?lang=ar"><input type="button" value="AR" size="45" /></a>&nbsp;&nbsp;<a href="premiere.php?lang=fr"><input type="button" value="FR" size="45"/></a></li>
...
function ouvrirpage(){
    ...
    <div class="bolck_head">1ére année </div>
