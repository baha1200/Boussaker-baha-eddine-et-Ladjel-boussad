...
<head>
    ...
    <title>cinqieme</title>
	<style>
	table{border-collapse: collapse; width: 100%; height: 4cm; margin-top: 10px; text-align: center;table-layout: fixed; word-wrap: break-word;}
...
<body>
    ...
    <div class="nev">
        <ul>
            <li><a href="cinqieme.php?lang=ar"><input type="button" value="AR" size="45" /></a>&nbsp;&nbsp;<a href="cinqieme.php?lang=fr"><input type="button" value="FR" size="45"/></a></li>
...
function ouvrirpage(){
    ...
    <div class="bolck_head"><?php echo $lang['khamsa']; ?></div> <br><br><br>
